                            ...
                            Row(
                                ...
                                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                    ...
                                    LazyColumn(
                                        ...
                                        items(pokemonDetails.stats.size) { item ->
                                            Text(
                                                text = //pokemonDetails.stats[item].stat.name,
                                                stringResource(
                                                    id = R.string.stat_value,
                                                    pokemonDetails.stats[item].stat.name,
                                                    pokemonDetails.stats[item].baseStat
                                                ),
